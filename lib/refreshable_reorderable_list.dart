...
/// The callback used by [RefreshableReorderableListView] to move an item to a new
/// position in a list.
///
...
/// [RefreshableReorderableListView] will need to account for this when inserting before
/// [newIndex].
///
...
///
/// {@youtube 560 315 https://www.youtube.com/watch?v=3fB1mxOsqJE}
class RefreshableReorderableListView extends StatefulWidget {
  ...
  /// underlying list.
  ///
  /// This [RefreshableReorderableListView] calls [onReorder] after a list child is dropped
  /// into a new position.
...
class _RefreshableReorderableListViewState extends State<RefreshableReorderableListView> {
  // We use an inner overlay so that the dragging list item doesn't draw outside of the list itself.
  final GlobalKey _overlayKey = GlobalKey(debugLabel: '$RefreshableReorderableListView overlay key');
...
class _ReorderableListContentState extends State<_ReorderableListContent>
  ...
  static const double _defaultDropAreaExtent = 100;

  // The additional margin to place around a computed drop area.
  static const double _dropAreaMargin = 8;
